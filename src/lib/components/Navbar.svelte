...
=======
    import logo from "$lib/assets/Logo.png";
>>>>>>> 1d67e6610e199dbef8b5b83f5d4bcb9b1d5de511
</script>
...
>
    ...
    >
        <div
            class="left-10 absolute z-50 bg-gray-100 flex items-center px-4 py-2.5 rounded max-lg:hidden"
        >
            <svg
...
=======
        <div
            class="lg:absolute lg:right-10 flex items-center ml-auto space-x-8"
        >
            <span class="relative">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
