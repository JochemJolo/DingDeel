...
<header class='shadow-md bg-white font-[sans-serif] tracking-wide relative z-50'>
    <section class='py-2 bg-[#007bff] text-white text-right px-10'>
        <p class='text-sm text-center'><strong class="mx-3">Vandaag en morgen alles 2x zo duur!</strong></p>
      </section>
      <section
        ...
        <div id="collapseMenu"
          ...
          <ul
            ...
            <li class='group max-lg:border-b max-lg:px-3 max-lg:py-3 relative'>
              <a href="page"
                class='hover:text-[#007bff] hover:fill-[#007bff] text-gray-800 text-[15px] flex items-center'>Kleding<svg
            ...
            <li class='max-lg:border-b max-lg:px-3 max-lg:py-3'><a href="page"
              class='hover:text-[#007bff] text-gray-800 text-[15px] block'>Gereedschap</a></li>
            <li class='max-lg:border-b max-lg:px-3 max-lg:py-3'><a href="page"
              class='hover:text-[#007bff] text-gray-800 text-[15px] block'>Voertuigen</a></li>
            <li class='max-lg:border-b max-lg:px-3 max-lg:py-3'><a href="page"
              class='hover:text-[#007bff] text-gray-800 text-[15px] block'>Mensen</a></li>
            <li class='max-lg:border-b max-lg:px-3 max-lg:py-3'><a href="page"
